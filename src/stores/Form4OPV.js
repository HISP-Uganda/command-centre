...
export class Form4OPV {
    ...
    @action setCurrentSearch = async val => {
        ...
        if (level === 1) {
            ...
            // this.currenOPVTarget = mrTargets.filter(op => op.ou === val.id).reduce((a, b) => a + b.value, 0)
        } else if (level === 4) {
