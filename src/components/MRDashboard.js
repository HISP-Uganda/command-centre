            ...
            >
                ...
                <div key="d" style={{ background: 'white' }} className="flex-center">
                    ...
                    <div className="container" style={{ width: "20%" }}>
                        ...
                        <div className="red">{this.store.MR.posts === 0 ? 0 : (100 * this.store.MR.textValues.posts / this.store.MR.posts).toFixed(1)}%</div>
                    </div>
                    <div className="container" style={{ width: "20%" }}>
                    ...
                    <Progress strokeWidth={15} showInfo={false} type="circle" percent={this.store.MR.posts === 0 ? 0 : (100 * this.store.MR.textValues.posts / this.store.MR.posts)} width={80} style={{ width: '20%', textAlign: "center" }} />
                </div>
                ...
                <div key="m" style={{ background: 'white' }} className="flex-center">
                    ...
                    <div className="container" style={{ width: "20%" }}>
                        <div style={{ color: '#000066' }}>MR COVERAGE (DISTRICT)</div>
                        <div className="green">{this.store.MR.textValues.covarage}%</div>
                    </div>

                    <div className="container" style={{ width: "20%" }}>
                        <div style={{ color: '#000066' }}>MR COVERAGE (UBOS)</div>
                        <div className="green">{this.store.MR.estimates}%</div>
                    </div>
                    <Progress strokeWidth={15} showInfo={false} type="circle" percent={isNaN(this.store.MR.estimates) ? 0 : this.store.MR.estimates} width={80} style={{ width: '20%', textAlign: "center" }} />
                </div>
                ...
                <div key="n" style={{ background: 'white' }}>
                    <Table dataSource={this.store.MR.mrTableData} columns={columns} loading={this.store.MR.loading} pagination={{ pageSize: 10 }} rowKey="id" scroll={{ x: true }} size="middle" />
                </div>
                <div key="o" style={{ background: 'white' }}>
                    <Table dataSource={this.store.MR.cumulativeMRTableData} columns={columns} loading={this.store.MR.loading} pagination={{ pageSize: 10 }} rowKey="id" scroll={{ x: true }} size="middle" />
                </div>
                ...
                <div key="h" style={{ background: 'white' }} className="flex-center">
                    ...
                    <div className="container" style={{ width: '50%' }}>
                        ...
                        <div className="red">{this.store.MR.textValues.used ? this.store.MR.textValues.used : 0}</div>
                    </div>
                </div>
